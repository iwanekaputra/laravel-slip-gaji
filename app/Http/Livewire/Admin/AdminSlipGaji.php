...
class AdminSlipGaji extends Component
{
    ...
    public function redirectIndex() {
        ...
        foreach($slipSalaries as $slipSalary) {
            ...
            'caption' => 'Assalamualaikum Wr.Wb. Yth. Bapak/Ibu Pegawai Inspektorat Kabupaten Kuningan. Mohon izin menyampaikan informasi rincian gaji (slip gaji) bulan xxx tahun xxx melalui media elektronik (Whatsapp personal). Bagi Bapak/Ibu yang menghendaki untuk tetap diprint, bisa langsung membalas pesan ini. Demikian informasi yang dapat disampaikan, terimakasih atas perhatiannya. Wassalamualaikum Wr. Wb.',
            ];
